...
ReadPackage( "Catreps", "gap/constants.gd" );
ReadPackage( "Catreps", "gap/categories.gd" );
ReadPackage( "Catreps", "gap/categoriesandgroups.gd" );
ReadPackage( "Catreps", "gap/constants.gd" );
ReadPackage( "Catreps", "gap/homomorphisms.gd" );
ReadPackage( "Catreps", "gap/representation.gd" );
ReadPackage( "Catreps", "gap/vectors.gd" );
ReadPackage( "Catreps", "gap/utils.gd" );
