...
ReadPackage( "Catreps", "gap/constants.gi" );
ReadPackage( "Catreps", "gap/categories.gi" );
ReadPackage( "Catreps", "gap/categoriesandgroups.gi" );
ReadPackage( "Catreps", "gap/constants.gi" );
ReadPackage( "Catreps", "gap/homomorphisms.gi" );
ReadPackage( "Catreps", "gap/representation.gi" );
ReadPackage( "Catreps", "gap/vectors.gi" );
ReadPackage( "Catreps", "gap/utils.gi" );
